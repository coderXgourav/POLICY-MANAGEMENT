  ...
  return (function () {
    var t = {
          ...
          class s extends r.EmbedBlot {
            ...
            restore() {
              ...
              if ((this.remove(), t)) {
                ...
                if (null !== s && null !== o) return { startNode: c.domNode, startOffset: s, endNode: c.domNode, endOffset: o }
              }
              return null
            }
            update(t, e) {
          ...
          class o extends r.EmbedBlot {
            ...
            restore(t) {
              ...
              if (t === this.leftGuard)
                ...
                t === this.rightGuard &&
                  (this.next instanceof i.A ? (this.next.insertAt(0, r), (n = { startNode: this.next.domNode, startOffset: r.length })) : ((e = document.createTextNode(r)), this.parent.insertBefore(this.scroll.create(e), this.next), (n = { startNode: e, startOffset: r.length })))
              return (t.data = s), n
            }
            update(t, e) {
              t.forEach((t) => {
        ...
        3729: function (t, e, n) {
                  ...
                  if (r)
                    if ('string' == typeof r) {
                      ...
                      i.slice(0, -1).forEach((r) => {
                        n.insert(r, t.attributes), e.push({ type: 'block', delta: n, attributes: t.attributes ?? {} }), (n = new (d())())
                      })
                      ...
                      if (!i) return
                      this.query(i, u.Scope.INLINE) ? n.push(t) : (n.length() && e.push({ type: 'block', delta: n, attributes: {} }), (n = new (d())()), e.push({ type: 'blockEmbed', key: i, value: r[i], attributes: t.attributes ?? {} }))
                    }
                }),
          ...
          class N extends x.A {
              ...
              super(t, e),
                this.quill.on(r.Ay.events.EDITOR_CHANGE, (t, e, n, i) => {
                  t === r.Ay.events.SELECTION_CHANGE
                    ...
                    : t === r.Ay.events.TEXT_CHANGE && (this.ignoreChange || (this.options.userOnly && i !== r.Ay.sources.USER ? this.transform(e) : this.record(e, n)), (this.currentRange = w(this.currentRange, e)))
                }),
                this.quill.keyboard.addBinding({ key: 'z', shortKey: !0 }, this.undo.bind(this)),
                this.quill.keyboard.addBinding({ key: ['z', 'Z'], shortKey: !0, shiftKey: !0 }, this.redo.bind(this)),
                /Win/i.test(navigator.platform) && this.quill.keyboard.addBinding({ key: 'y', shortKey: !0 }, this.redo.bind(this)),
            ...
            change(t, e) {
              ...
              const i = this.quill.getContents(),
                s = n.delta.invert(i)
              this.stack[e].push({ delta: s, range: w(n.range, s) }), (this.lastRecorded = 0), (this.ignoreChange = !0), this.quill.updateContents(n.delta, r.Ay.sources.USER), (this.ignoreChange = !1), this.restoreSelection(n)
            }
            clear() {
            ...
            record(t, e) {
              ...
              0 !== n.length() && (this.stack.undo.push({ delta: n, range: r }), this.stack.undo.length > this.options.maxStack && this.stack.undo.shift())
            }
            redo() {
          ...
          function E(t, e) {
            ...
            for (let e = t.length - 1; e >= 0; e -= 1) {
              const r = t[e]
              ;(t[e] = { delta: n.transform(r.delta, !0), range: r.range && w(r.range, n) }), (n = r.delta.transform(n)), 0 === t[e].delta.length() && t.splice(e, 1)
            }
          }
          function w(t, e) {
            if (!t) return t
        ...
        6142: function (t, e, n) {
          ...
          var x = class {
              ...
              applyDelta(t) {
                ...
                return (
                    ...
                    return (
                      t.forEach((t) => {
                        'string' == typeof t.insert
                          ? t.insert.split('\n').forEach((n, r) => {
                              r && e.push({ insert: '\n', attributes: t.attributes }), n && e.push({ insert: n, attributes: t.attributes })
                            })
                          : e.push(t)
                      }),
                      e
                  ...
                  l.reduce((t, e) => ('number' == typeof e.delete ? (this.scroll.deleteAt(t, e.delete), t) : t + s.Op.length(e)), 0),
          ...
          class I {
            static DEFAULTS = { bounds: null, modules: { clipboard: !0, keyboard: !0, history: !0, uploader: !0 }, placeholder: '', readOnly: !1, registry: R, theme: 'default' }
            ...
            constructor(t) {
              ...
              if (
                ((this.options = (function (t, e) {
                  ...
                  return (
                    d
                      ? e.formats && C.warn('Ignoring "formats" option because "registry" is specified')
                      : (d = e.formats
                          ? ((t, e, n) => {
                          ...
                          : h.registry),
                    {
                      ...
                      modules: Object.entries(u).reduce((t, e) => {
                        ...
                        return null == s ? (C.error(`Cannot load ${n} module. Are you sure you registered it?`), t) : { ...t, [n]: (0, r.A)({}, s.DEFAULTS || {}, i) }
                      }, {}),
                      bounds: B(h.bounds)
                    }
                  )
            ...
            format(t, e) {
              ...
              return D.call(
                ...
                () => {
                  ...
                  let r = new (o())()
                  if (null == n) return r
                  if (this.scroll.query(t, i.Scope.BLOCK)) r = this.editor.formatLine(n.index, n.length, { [t]: e })
                  else {
            ...
            scrollRectIntoView(t) {
              ;((t, e) => {
                ...
                for (; i; ) {
                  const t = i === n.body,
                    e = t ? { top: 0, right: window.visualViewport?.width ?? n.documentElement.clientWidth, bottom: window.visualViewport?.height ?? n.documentElement.clientHeight, left: 0 } : S(i),
          ...
          function P(t, e, n, r, i) {
            let s = {}
            return (
              'number' == typeof t.index && 'number' == typeof t.length ? ('number' != typeof e ? ((i = r), (r = n), (n = e), (e = t.length), (t = t.index)) : ((e = t.length), (t = t.index))) : 'number' != typeof e && ((i = r), (r = n), (n = e), (e = 0)),
          ...
          function z(t, e, n, r) {
            ...
            return (
              e && 'function' == typeof e.transformPosition
                ? ([s, o] = [t.index, t.index + t.length].map((t) => e.transformPosition(t, r !== N.A.sources.USER)))
                : ([s, o] = [t.index, t.index + t.length].map((t) => (t < e || (t === e && r === N.A.sources.USER) ? t : i >= 0 ? t + i : Math.max(e, t + i)))),
              new f.Q(s, o - s)
            )
          }
        },
        8298: function (t, e, n) {
          ...
          class c {
            ...
            normalizeNative(t) {
              ...
              const e = { start: { node: t.startContainer, offset: t.startOffset }, end: { node: t.endContainer, offset: t.endOffset }, native: t }
              return (
        ...
        664: function (t, e, n) {
          ...
          var r = n(6003)
          const i = new r.ClassAttributor('size', 'ql-size', { scope: r.Scope.INLINE, whitelist: ['small', 'large', 'huge'] }),
            s = new r.StyleAttributor('size', 'font-size', { scope: r.Scope.INLINE, whitelist: ['10px', '18px', '32px'] })
        },
        584: function (t, e, n) {
          'use strict'
          n.d(e, {
                ...
                function (t, e, n) {
                  ...
                  if (!R(t)) {
                    ...
                    ;(r = r.replace(/\r\n/g, ' ').replace(/\n/g, ' ')),
                      ...
                      ((null == t.previousSibling && null != t.parentElement && j(t.parentElement, n)) || (t.previousSibling instanceof Element && j(t.previousSibling, n))) && (r = r.replace(/^\s+/, i.bind(i, !1))),
                      ((null == t.nextSibling && null != t.parentElement && j(t.parentElement, n)) || (t.nextSibling instanceof Element && j(t.nextSibling, n))) && (r = r.replace(/\s+$/, i.bind(i, !1)))
                  }
                  return e.insert(r)
                }
              ],
                    ...
                    i
                      ...
                      .forEach((e) => {
                        ...
                        ;(null != i && ((l[i.attrName] = i.value(t)), l[i.attrName])) ||
                          ((i = _[e]), null == i || (i.attrName !== e && i.keyName !== e) || (l[i.attrName] = i.value(t) || void 0), (i = L[e]), null == i || (i.attrName !== e && i.keyName !== e) || ((i = L[e]), (l[i.attrName] = i.value(t) || void 0)))
                      }),
          ...
          class S extends a.A {
            ...
            onCaptureCopy(t) {
              ...
              t.clipboardData?.setData('text/plain', i), t.clipboardData?.setData('text/html', r), e && (0, b.Xo)({ range: n, quill: this.quill })
            }
            normalizeURIList(t) {
              return t
                .split(/\r?\n/)
        ...
        8123: function (t, e, n) {
            ...
            constructor(t, e) {
              super(t, e),
                ...
                /Firefox/i.test(navigator.userAgent)
                  ? (this.addBinding({ key: 'Backspace' }, { collapsed: !0 }, this.handleBackspace), this.addBinding({ key: 'Delete' }, { collapsed: !0 }, this.handleDelete))
                  : (this.addBinding({ key: 'Backspace' }, { collapsed: !0, prefix: /^.?$/ }, this.handleBackspace), this.addBinding({ key: 'Delete' }, { collapsed: !0, suffix: /^.?$/ }, this.handleDelete)),
                ...
                this.addBinding({ key: 'Backspace', altKey: null, ctrlKey: null, metaKey: null, shiftKey: null }, { collapsed: !0, offset: 0 }, this.handleBackspace),
                this.listen()
            }
            addBinding(t) {
              let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            listen() {
              this.quill.root.addEventListener('keydown', (t) => {
                ...
                const [s, o] = this.quill.getLine(i.index),
                  ...
                  m = { collapsed: 0 === i.length, empty: 0 === i.length && s.length() <= 1, format: this.quill.getFormat(i), line: s, offset: o, prefix: p, suffix: g, event: t }
                e.some((t) => {
          ...
          const p = {
            bindings: {
              ...
              'table backspace': { key: 'Backspace', format: ['table'], collapsed: !0, offset: 0, handler() {} },
              'table delete': { key: 'Delete', format: ['table'], collapsed: !0, suffix: /^$/, handler() {} },
              'table enter': {
                key: 'Enter',
                shiftKey: null,
                format: ['table'],
                  ...
                  for (var i = !1, s = [], o = 0, g = null, m = 0, b = 0, y = 0, v = 0, A = 0; m < t.length; )
                    t[m][0] == r
                      ...
                      : (t[m][0] == n ? (v += t[m][1].length) : (A += t[m][1].length),
                        g && g.length <= Math.max(b, y) && g.length <= Math.max(v, A) && (t.splice(s[o - 1], 0, [e, g]), (t[s[o - 1] + 1][0] = n), o--, (m = --o > 0 ? s[o - 1] : -1), (b = 0), (y = 0), (v = 0), (A = 0), (g = null), (i = !0))),
                      m++
                  for (
                    i && p(t),
                      (function (t) {
                    ...
                    if (t[m - 1][0] == e && t[m][0] == n) {
                      var x = t[m - 1][1],
                        ...
                        w = l(N, x)
                      E >= w
                        ? (E >= x.length / 2 || E >= N.length / 2) && (t.splice(m, 0, [r, N.substring(0, E)]), (t[m - 1][1] = x.substring(0, x.length - E)), (t[m + 1][1] = N.substring(E)), m++)
                        : (w >= x.length / 2 || w >= N.length / 2) && (t.splice(m, 0, [r, x.substring(0, w)]), (t[m - 1][0] = n), (t[m - 1][1] = N.substring(0, N.length - w)), (t[m + 1][0] = e), (t[m + 1][1] = x.substring(w)), m++),
                        m++
                    }
                    m++
                  }
                ...
                switch (t[l][0]) {
                  ...
                  case r:
                    ...
                    if (h.length > 0 || d.length > 0) {
                      h.length > 0 &&
                        d.length > 0 &&
                        (0 !== (s = o(d, h)) && (f >= 0 ? (t[f][1] += d.substring(0, s)) : (t.splice(0, 0, [r, d.substring(0, s)]), l++), (d = d.substring(s)), (h = h.substring(s))),
                        0 !== (s = a(d, h)) && ((t[l][1] = d.substring(d.length - s) + t[l][1]), (d = d.substring(0, d.length - s)), (h = h.substring(0, h.length - s))))
                      var v = u + c
            ...
            for (l = 1; l < t.length - 1; )
              t[l - 1][0] === r &&
                ...
                (t[l][1].substring(t[l][1].length - t[l - 1][1].length) === t[l - 1][1]
                  ? ((t[l][1] = t[l - 1][1] + t[l][1].substring(0, t[l][1].length - t[l - 1][1].length)), (t[l + 1][1] = t[l - 1][1] + t[l + 1][1]), t.splice(l - 1, 1), (A = !0))
                  : t[l][1].substring(0, t[l + 1][1].length) == t[l + 1][1] && ((t[l - 1][1] += t[l + 1][1]), (t[l][1] = t[l][1].substring(t[l + 1][1].length) + t[l + 1][1]), t.splice(l + 1, 1), (A = !0))),
                l++
            A && p(t, i)
          }
          function g(t) {
        ...
        9629: function (t, e, n) {
          ...
          ;((ft && Ut(new ft(new ArrayBuffer(1))) != A) || (pt && Ut(new pt()) != u) || (gt && Ut(gt.resolve()) != f) || (mt && Ut(new mt()) != g) || (bt && Ut(new bt()) != y)) &&
            (Ut = function (t) {
              var e = et.call(t),
        ...
        4162: function (t, e, n) {
          ...
          ;((ut && Mt(new ut(new ArrayBuffer(1))) != _) || (ht && Mt(new ht()) != g) || (dt && Mt(dt.resolve()) != v) || (ft && Mt(new ft()) != N) || (pt && Mt(new pt()) != q)) &&
            (Mt = function (t) {
              var e = St(t),
          ...
          function Gt(t) {
            return null != (e = t) && Vt(e.length) && !Ht(e)
              ? (function (t, e) {
                  var n = Ft(t),
                    r = !n && zt(t),
                    i = !n && !r && $t(t),
        ...
        6770: function (t, e, n) {
          ...
          var r = n(7889)
          e.A = function (t, e, n) {
            '__proto__' == e && r.A ? (0, r.A)(t, e, { configurable: !0, enumerable: !0, value: n, writable: !0 }) : (t[e] = n)
          }
        },
        1381: function (t, e, n) {
          'use strict'
        ...
        7995: function (t, e, n) {
          ...
          var r = n(2281),
            ...
            x = (0, h.A)(c),
            N = u.A
          ;((s && N(new s(new ArrayBuffer(1))) != m) || (o.A && N(new o.A()) != d) || (l && N(l.resolve()) != f) || (a && N(new a()) != p) || (c && N(new c()) != g)) &&
            (N = function (t) {
              var e = (0, u.A)(t),
                ...
                if (k) {
                  ...
                  ;(q = c),
                    R || I || B
                      ? (0, b.A)(a)
                        ? (q = a)
                        : ((l = a), (0, v.A)(l) && (0, y.A)(l) ? (q = (0, p.A)(a)) : I ? ((k = !1), (q = (0, d.A)(c, !0))) : B ? ((k = !1), (q = (0, f.A)(c, !0))) : (q = []))
                      : (function (t) {
                ...
                'string' == typeof t
                  ...
                  : t instanceof Text || t.nodeType === Node.TEXT_NODE
                    ...
                    : 'number' == typeof t
                      ...
                      : t instanceof Element && ((t.getAttribute('class') || '').split(/\s+/).some((t) => ((n = this.classes[t]), !!n)), (n = n || this.tags[t.tagName])),
                ...
                return (
                  ...
                  n
                    ...
                    : e &&
                      ...
                      t.tagName &&
                        (Array.isArray(t.tagName) ? (t.tagName = t.tagName.map((t) => t.toUpperCase())) : (t.tagName = t.tagName.toUpperCase()),
              ...
              static create(t) {
                ...
                return (
                  Array.isArray(this.tagName)
                    ? ('string' == typeof t ? ((n = t.toUpperCase()), parseInt(n, 10).toString() === n && (n = parseInt(n, 10))) : 'number' == typeof t && (n = t),
                      (e = 'number' == typeof n ? document.createElement(this.tagName[n - 1]) : n && this.tagName.indexOf(n) > -1 ? document.createElement(n) : document.createElement(this.tagName[0])))
          ...
          class b {
            ...
            insertBefore(t, e) {
              null != t &&
                (this.remove(t),
                (t.next = e),
                null != e ? ((t.prev = e.prev), null != e.prev && (e.prev.next = t), (e.prev = t), e === this.head && (this.head = t)) : null != this.tail ? ((this.tail.next = t), (t.prev = this.tail), (this.tail = t)) : ((t.prev = null), (this.head = this.tail = t)),
                (this.length += 1))
            }
            offset(t) {
              let e = 0,
            ...
            update(t, e) {
              ...
              t.forEach((t) => {
                ...
                n
                  ...
                  .sort((t, e) => (t === e ? 0 : t.compareDocumentPosition(e) & Node.DOCUMENT_POSITION_FOLLOWING ? 1 : -1))
                  .forEach((t) => {
                    let e = null
