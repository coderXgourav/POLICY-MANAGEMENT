      ...
      function (e, t, n) {
        ...
        ;(i.prototype = {
          ...
          _setPosition: function (e) {
            ...
            ;(this._mapA.getContainer().style.clip = n), (this._mapB.getContainer().style.clip = i), (this.currentPosition = e)
          },
          _onMove: function (e) {
          ...
          _getX: function (e) {
            var t = (e = e.touches ? e.touches[0] : e).clientX - this._bounds.left
            return t < 0 && (t = 0), t > this._bounds.width && (t = this._bounds.width), t
          },
          _getY: function (e) {
            var t = (e = e.touches ? e.touches[0] : e).clientY - this._bounds.top
            return t < 0 && (t = 0), t > this._bounds.height && (t = this._bounds.height), t
          },
          ...
          remove: function () {
            ...
            t && ((t.style.clip = null), t.removeEventListener('mousemove', this._onMove)), this._swiper.removeEventListener('mousedown', this._onDown), this._swiper.removeEventListener('touchstart', this._onDown), this._controlContainer.remove()
          }
        }),
          window.mapboxgl ? (mapboxgl.Compare = i) : void 0 !== t && (t.exports = i)
      },
    ...
    3: [
      function (e, t, n) {
        ...
        function l(e, t, n, i) {
          ...
          if (((r = e._events) ? (r.newListener && (e.emit('newListener', t, n.listener ? n.listener : n), (r = e._events)), (s = r[t])) : ((r = e._events = u(null)), (e._eventsCount = 0)), s)) {
            if (('function' == typeof s ? (s = r[t] = i ? [n, s] : [s, n]) : i ? s.unshift(n) : s.push(n), !s.warned && (o = c(e)) && 0 < o && s.length > o)) {
              s.warned = !0
              var h = new Error('Possible EventEmitter memory leak detected. ' + s.length + ' "' + String(t) + '" listeners added. Use emitter.setMaxListeners() to increase limit.')
              ;(h.name = 'MaxListenersExceededWarning'), (h.emitter = e), (h.type = t), (h.count = s.length), 'object' == typeof console && console.warn && console.warn('%s: %s', h.name, h.message)
            }
        ...
        o
          ...
          (i.prototype.emit = function (e, t, n, i) {
            ...
            if (c) {
              if ((1 < arguments.length && (o = t), o instanceof Error)) throw o
            ...
            switch ((s = arguments.length)) {
              case 1:
                !(function (e, t, n) {
                  if (t) e.call(n)
                  else for (var i = e.length, o = _(e, i), r = 0; r < i; ++r) o[r].call(n)
                })(r, f, this)
                break
              case 2:
                !(function (e, t, n, i) {
                  if (t) e.call(n, i)
                  else for (var o = e.length, r = _(e, o), s = 0; s < o; ++s) r[s].call(n, i)
                })(r, f, this, t)
                break
              case 3:
                !(function (e, t, n, i, o) {
                  if (t) e.call(n, i, o)
                  else for (var r = e.length, s = _(e, r), h = 0; h < r; ++h) s[h].call(n, i, o)
                })(r, f, this, t, n)
                break
              case 4:
                !(function (e, t, n, i, o, r) {
                  if (t) e.call(n, i, o, r)
                  else for (var s = e.length, h = _(e, s), u = 0; u < s; ++u) h[u].call(n, i, o, r)
                })(r, f, this, t, n, i)
                break
              default:
                for (h = new Array(s - 1), u = 1; u < s; u++) h[u - 1] = arguments[u]
                !(function (e, t, n, i) {
                  if (t) e.apply(n, i)
                  else for (var o = e.length, r = _(e, o), s = 0; s < o; ++s) r[s].apply(n, i)
                })(r, f, this, h)
            }
            return !0
          }),
          ...
          (i.prototype.removeListener = function (e, t) {
            ...
            if (n === t || n.listener === t) 0 == --this._eventsCount ? (this._events = u(null)) : (delete i[e], i.removeListener && this.emit('removeListener', e, n.listener || t))
              ...
              0 === o
                ? n.shift()
                : (function (e, t) {
                    for (var n = t, i = n + 1, o = e.length; i < o; n += 1, i += 1) e[n] = e[i]
                    e.pop()
                  })(n, o),
                1 === n.length && (i[e] = n[0]),
          ...
          (i.prototype.removeAllListeners = function (e) {
            ...
            else if (t) for (i = t.length - 1; 0 <= i; i--) this.removeListener(e, t[i])
            return this
          }),
