!(function () {
  ...
  var p = {
    ...
    f = (function (n) {
      ...
      function o(n, r) {
        var l, c, d, h
        if ((i(this, o), ((l = s(this, ((c = o), a(c)).call(this))).element = n), (l.clickableElements = []), (l.listeners = []), (l.files = []), 'string' == typeof l.element && (l.element = document.querySelector(l.element)), !l.element || null == l.element.nodeType))
              ...
              value: function () {
                ...
                return (
                  'FORM' !== this.element.tagName
                    ? (t = o.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(n)
                      ...
                      if (i.length > 0) {
                        ...
                        try {
                          for (var l, s = i[Symbol.iterator](); !(n = (l = s.next()).done); n = !0) {
                            ...
                            u.isFile
                              ? u.file(function (e) {
                                  if (!c.options.ignoreHiddenFiles || '.' !== e.name.substring(0, 1)) return (e.fullPath = ''.concat(t, 'https://softivuspro.com/').concat(e.name)), c.addFile(e)
                                })
                              : u.isDirectory && e._addFilesFromDirectory(u, ''.concat(t, 'https://softivuspro.com/').concat(u.name))
                          }
                        } catch (e) {
                          ;(r = !0), (o = e)
                        } finally {
                ...
                if (e[0].upload.chunked) {
                  ...
                  try {
                    for (var s, u = e[Symbol.iterator](); !(n = (s = u.next()).done); n = !0) {
                      var c
                      ;((c = s.value).upload.total && c.upload.bytesSent && c.upload.bytesSent == c.upload.total) ||
                        (i ? ((c.upload.progress = (100 * i.loaded) / i.total), (c.upload.total = i.total), (c.upload.bytesSent = i.loaded)) : ((c.upload.progress = 100), (c.upload.bytesSent = c.upload.total)), this.emit('uploadprogress', c, c.upload.progress, c.upload.bytesSent))
                    }
                  } catch (e) {
                    ;(r = !0), (a = e)
                  } finally {
