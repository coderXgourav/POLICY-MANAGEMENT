...
var FullCalendar = (function (e) {
  ...
  function T(e, t, n, r, i, s, o, a, l, c) {
    ...
    for (n.__k = [], h = 0; h < t.length; h++)
      if (
        null !=
        (p = n.__k[h] =
          null == (p = t[h]) || 'boolean' == typeof p ? null : 'string' == typeof p || 'number' == typeof p || 'bigint' == typeof p ? m(null, p, null, null, p) : Array.isArray(p) ? m(y, { children: p }, null, null, null) : p.__b > 0 ? m(p.type, p.props, p.key, p.ref ? p.ref : null, p.__v) : p)
      ) {
        ...
        N(e, p, (g = g || d), i, s, o, a, l, c),
          ...
          null != v ? (null == b && (b = v), 'function' == typeof p.type && p.__k === g.__k ? (p.__d = l = k(p, l, e)) : (l = I(e, p, g, S, v, l)), 'function' == typeof n.type && (n.__d = l)) : l && g.__e == l && l.parentNode != e && (l = w(g))
      }
      ...
      e: if ('function' == typeof _) {
        if (
          ...
          r.__c
            ...
            : ('prototype' in _ && _.prototype.render ? (t.__c = u = new _(b, S)) : ((t.__c = u = new D(b, S)), (u.constructor = _), (u.render = z)), E && E.sub(u), (u.props = b), u.state || (u.state = {}), (u.context = S), (u.__n = i), (h = u.__d = !0), (u.__h = []), (u._sb = [])),
  ...
  class Hn {
    ...
    createMarkerMeta(e) {
      ...
      let t = null
      return 'number' == typeof e ? (t = this.timestampToMarker(e)) : e instanceof Date ? ((e = e.valueOf()), isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = Bt(e)), null !== t && jt(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } : null
    }
    parse(e) {
      let t = Pn(e)
    ...
    formatRange(e, t, n, r = {}) {
      return r.isEndExclusive && (t = Ct(t, -1)), n.formatRange({ marker: e, timeZoneOffset: null != r.forcedStartTzo ? r.forcedStartTzo : this.offsetForMarker(e) }, { marker: t, timeZoneOffset: null != r.forcedEndTzo ? r.forcedEndTzo : this.offsetForMarker(t) }, this, r.defaultSeparator)
    }
    formatIso(e, t = {}) {
      let n = null
  ...
  class er extends Gn {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        r = { view: t.viewApi }
      return p(Jn, Object.assign({}, e, { elTag: e.elTag || 'div', elClasses: [...tr(e.viewSpec), ...(e.elClasses || [])], renderProps: r, classNameGenerator: n.viewClassNames, generatorName: void 0, didMount: n.viewDidMount, willUnmount: n.viewWillUnmount }), () => e.children)
    }
  }
  function tr(e) {
  ...
  class gr {
    ...
    build(e, t, n = !0) {
      ...
      return (
        ...
        (l = or(i.range, r)),
        lr(o, e) || (e = o.start),
        { currentDate: e, validRange: r, currentRange: i.range, currentRangeUnit: i.unit, isRangeAllDay: s, activeRange: a, renderRange: o, slotMinTime: c.slotMinTime, slotMaxTime: c.slotMaxTime, isValid: l, dateIncrement: this.buildDateIncrement(i.duration) }
      )
    }
    buildValidRange() {
      ...
      g &&
        ('inverse-background' === u.display
          ? d.groupId
            ? i[d.groupId].push(g)
            : s[o.defId].push(g)
          : 'none' !== u.display && ('background' === u.display ? a : l).push({ def: d, ui: u, instance: o, range: g, isStart: f.start && f.start.valueOf() === g.start.valueOf(), isEnd: f.end && f.end.valueOf() === g.end.valueOf() }))
    }
    for (let e in i) {
      let t = nr(i[e], n)
      for (let n of t) {
  ...
  function Fi(e, t, n, r) {
    return { dow: e.getUTCDay(), isDisabled: Boolean(r && !lr(r.activeRange, e)), isOther: Boolean(r && !lr(r.currentRange, e)), isToday: Boolean(t && lr(t, e)), isPast: Boolean(n ? e < n : !!t && e < t.start), isFuture: Boolean(n ? e > n : !!t && e >= t.end) }
  }
  function Vi(e, t) {
  ...
  class io extends Gn {
    ...
    renderChunkTd(e, t, n, r) {
      ...
      let { props: i } = this,
        ...
        u = e.key,
        h = Ys(e, n, { tableColGroupNode: t, tableMinWidth: '', clientWidth: i.collapsibleWidth || void 0 === o[u] ? null : o[u], clientHeight: void 0 !== a[u] ? a[u] : null, expandRows: e.expandRows, syncRowHeights: !1, rowSyncHeights: [], reportRowHeightChange: () => {} }, r)
      return p(
        r ? 'th' : 'td',
  ...
  class oo extends Gn {
    render() {
      ...
      return p(so, Object.assign({}, e, { elTag: 'a', elStyle: { borderColor: i.borderColor, backgroundColor: i.backgroundColor }, elAttrs: bi(r, t), defaultGenerator: ao, timeText: s }), (e, t) =>
        p(y, null, p(e, { elTag: 'div', elClasses: ['fc-event-main'], elStyle: { color: t.textColor } }), Boolean(t.isStartResizable) && p('div', { className: 'fc-event-resizer fc-event-resizer-start' }), Boolean(t.isEndResizable) && p('div', { className: 'fc-event-resizer fc-event-resizer-end' }))
      )
    }
  }
  function ao(e) {
  ...
  const lo = (e) =>
      p(Ln.Consumer, null, (t) => {
        ...
        return p(Jn, Object.assign({}, e, { elTag: e.elTag || 'div', renderProps: r, generatorName: 'nowIndicatorContent', customGenerator: n.nowIndicatorContent, classNameGenerator: n.nowIndicatorClassNames, didMount: n.nowIndicatorDidMount, willUnmount: n.nowIndicatorWillUnmount }))
      }),
    co = an({ day: 'numeric' })
  class uo extends Gn {
    constructor() {
  ...
  const vo = (e) =>
    p(Ln.Consumer, null, (t) => {
      ...
      return p(Jn, Object.assign({}, e, { renderProps: o, generatorName: 'weekNumberContent', customGenerator: r.weekNumberContent, defaultGenerator: yo, classNameGenerator: r.weekNumberClassNames, didMount: r.weekNumberDidMount, willUnmount: r.weekNumberWillUnmount }))
    })
  function yo(e) {
    return e.text
  }
    ...
    render() {
      ...
      return fe(
        p(
          ...
          p('div', { className: 'fc-popover-header ' + e.getClass('popoverHeader') }, p('span', { className: 'fc-popover-title', id: r.titleId }, n.title), p('span', { className: 'fc-popover-close ' + e.getIconClass('close'), title: t.closeHint, onClick: this.handleCloseClick })),
  ...
  function Lo(e) {
    return (t) =>
      p(Ln.Consumer, null, (n) =>
        p(Jn, { elTag: 'div', elClasses: tr(n.viewSpec), renderProps: Object.assign(Object.assign({}, t), { nextDayThreshold: n.options.nextDayThreshold }), generatorName: void 0, customGenerator: e.content, classNameGenerator: e.classNames, didMount: e.didMount, willUnmount: e.willUnmount })
      )
  }
  function Fo(e, t, n, r) {
    let i = Uo(e),
    ...
    processRawViewOptions(e, t, n, r, i) {
      ...
      for (let e in s)
        s[e] === l[e] || (hn[e] && hn[e](s[e], l[e]))
          ? (a[e] = c[e])
          : (s[e] === this.currentCalendarOptionsInput[e] || (hn[e] && hn[e](s[e], this.currentCalendarOptionsInput[e])) ? e in this.currentCalendarOptionsRefined && (a[e] = this.currentCalendarOptionsRefined[e]) : o[e] ? (a[e] = o[e](s[e])) : (u[e] = s[e]), (d = !0))
  ...
  class Ca extends Gn {
    ...
    render() {
      let { props: e, state: t } = this,
        ...
        i = '',
        s = ''
      return n ? (null !== t.availableWidth ? (i = t.availableWidth / n) : (s = (1 / n) * 100 + '%')) : (i = e.height || ''), p('div', { 'aria-labelledby': e.labeledById, ref: this.handleEl, className: r.join(' '), style: { height: i, paddingBottom: s } }, e.children)
    }
    componentDidMount() {
  ...
  class Pa {
    ...
    createEventFromTouch(e, t) {
      let n,
        ...
        o = 0
      return (
        i && i.length ? ((n = i[0].pageX), (r = i[0].pageY)) : ((n = e.pageX), (r = e.pageY)), t ? ((this.origPageX = n), (this.origPageY = r)) : ((s = n - this.origPageX), (o = r - this.origPageY)), { origEvent: e, isTouch: !0, subjectEl: this.subjectEl, pageX: n, pageY: r, deltaX: s, deltaY: o }
      )
    }
  }
  function Ha(e) {
  ...
  class Fa extends ms {
    ...
    tryStartDrag(e) {
      this.isDelayEnded &&
        ...
        ((this.pointer.wasTouchScroll && !this.touchScrollAllowed) || ((this.isDragging = !0), (this.mirrorNeedsRevert = !1), this.autoScroller.start(e.pageX, e.pageY, this.containerEl), this.emitter.trigger('dragstart', e), !1 === this.touchScrollAllowed && this.pointer.cancelTouchScroll()))
    }
    tryStopDrag(e) {
      ...
      super(e),
        ...
        (this.handleHitUpdate = (e, t) => {
          ...
          this.displayDrag(s, c),
            l ? Xe() : $e(),
            t || (i === s && qa(r, e) && (o = null), this.dragging.setMirrorNeedsRevert(!o), this.dragging.setMirrorIsVisible(!e || !this.subjectEl.getRootNode().querySelector('.fc-event-mirror')), (this.receivingContext = s), (this.validMutation = o), (this.mutatedRelevantEvents = a))
        }),
  ...
  class al extends Gn {
    render() {
      let { props: e } = this
      return p(oo, Object.assign({}, e, { elClasses: ['fc-daygrid-event', 'fc-daygrid-block-event', 'fc-h-event'], defaultTimeFormat: sl, defaultDisplayEventEnd: e.defaultDisplayEventEnd, disableResizing: !e.seg.eventRange.def.allDay }))
    }
  }
  class ll extends Gn {
    render() {
  ...
  function cl(e) {
    return p(y, null, p('div', { className: 'fc-daygrid-event-dot', style: { borderColor: e.borderColor || e.backgroundColor } }), e.timeText && p('div', { className: 'fc-event-time' }, e.timeText), p('div', { className: 'fc-event-title' }, e.event.title || p(y, null, ' ')))
  }
  class dl extends Gn {
    constructor() {
        ...
        (s, a) =>
          p(
            ...
            !a.isDisabled && (t.showDayNumber || ho(i) || t.forceDayTop)
              ? p('div', { className: 'fc-daygrid-day-top' }, p(s, { elTag: 'a', elClasses: ['fc-daygrid-day-number', l && 'fc-daygrid-month-start'], elAttrs: Object.assign(Object.assign({}, qi(e, o)), { id: n.dayNumberId }) }))
              : t.showDayNumber
        ...
        for (let e of t) {
          ...
          m && (a.isRtl ? ((y = 0), (v = c.lefts[t.lastCol] - c.lefts[t.firstCol])) : ((v = 0), (y = c.rights[t.firstCol] - c.rights[t.lastCol]))),
            h.push(
              p(
                'div',
                { className: 'fc-daygrid-event-harness' + (m ? ' fc-daygrid-event-harness-abs' : ''), key: pl(t), ref: u ? null : this.segHarnessRefs.createRef(ml(t)), style: { visibility: g ? '' : 'hidden', marginTop: m ? '' : e.marginTop, top: m ? e.absoluteTop : '', left: v, right: y } },
                ol(t) ? p(ll, Object.assign({ seg: t, isDragging: i, isSelected: f === l, defaultDisplayEventEnd: d }, mi(t, n))) : p(al, Object.assign({ seg: t, isDragging: i, isResizing: s, isDateSelecting: o, isSelected: f === l, defaultDisplayEventEnd: d }, mi(t, n)))
              )
            )
        }
      return h
  ...
  function Il(e) {
    ...
    return p(Ln.Consumer, null, (n) => {
      ...
      return p(
        Jn,
        { elTag: 'td', elClasses: t, elAttrs: { 'data-time': e.isoTimeStr }, renderProps: a, generatorName: 'slotLabelContent', customGenerator: i.slotLabelContent, defaultGenerator: Ol, classNameGenerator: i.slotLabelClassNames, didMount: i.slotLabelDidMount, willUnmount: i.slotLabelWillUnmount },
  ...
  class Hl extends ls {
        ...
        (this.renderHeadAxis = (e, t = '') => {
          ...
          return n.weekNumbers && 'day' === e
            ? p(vo, { elTag: 'th', elClasses: ['fc-timegrid-axis', 'fc-scrollgrid-shrink'], elAttrs: { 'aria-hidden': !0 }, date: i.start, defaultFormat: Pl }, (e) =>
                p('div', { className: ['fc-timegrid-axis-frame', 'fc-scrollgrid-shrink-frame', 'fc-timegrid-axis-frame-liquid'].join(' '), style: { height: t } }, p(e, { elTag: 'a', elClasses: ['fc-timegrid-axis-cushion', 'fc-scrollgrid-shrink-cushion', 'fc-scrollgrid-sync-inner'], elAttrs: s }))
              )
    ...
    renderSimpleLayout(e, t, n) {
      ...
      return (
        ...
        t && (s.push({ type: 'body', key: 'all-day', chunk: { content: t } }), s.push({ type: 'body', key: 'all-day-divider', outerContent: p('tr', { role: 'presentation', className: 'fc-scrollgrid-section' }, p('td', { className: 'fc-timegrid-divider ' + r.theme.getClass('tableCellShaded') })) })),
    ...
    renderHScrollLayout(e, t, n, r, i, s, o) {
      ...
      e &&
        ...
        t &&
          ...
          h.push({ key: 'all-day-divider', type: 'body', outerContent: p('tr', { role: 'presentation', className: 'fc-scrollgrid-section' }, p('td', { colSpan: 2, className: 'fc-timegrid-divider ' + l.theme.getClass('tableCellShaded') })) }))
      ...
      return (
        ...
        p(er, { elRef: this.rootElRef, elClasses: ['fc-timegrid'], viewSpec: l.viewSpec }, p(a, { liquid: !c.isHeightAuto && !c.forPrint, forPrint: c.forPrint, collapsibleWidth: !1, colGroups: [{ width: 'shrink', cols: [{ width: 'shrink' }] }, { cols: [{ span: r, minWidth: i }] }], sections: h }))
      )
    }
  ...
  class Kl extends Gn {
    ...
    render() {
      ...
      return p(uo, { elTag: 'td', elRef: e.elRef, elClasses: ['fc-timegrid-col', ...(e.extraClassNames || [])], elAttrs: Object.assign({ role: 'gridcell' }, e.extraDataAttrs), date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, extraRenderProps: e.extraRenderProps }, (t) =>
        p(
          'div',
            ...
            p(
              ...
              e.axis &&
                p(
                  ...
                  p('div', { className: 'fc-timegrid-col-frame' }, p('div', { className: 'fc-timegrid-now-indicator-container' }, 'number' == typeof n && p(lo, { elClasses: ['fc-timegrid-now-indicator-arrow'], elStyle: { top: n }, isAxis: !0, date: e.nowDate })))
                ),
              e.cells.map((t, n) =>
                p(Kl, {
                  key: t.key,
  ...
  class rc extends ls {
    ...
    render() {
      ...
      return p(
        ...
        p(Ul, { axis: e.axis, dateProfile: e.dateProfile, slatMetas: e.slatMetas, clientWidth: e.clientWidth, minHeight: e.expandRows ? e.clientHeight : '', tableMinWidth: e.tableMinWidth, tableColGroupNode: e.axis ? e.tableColGroupNode : null, onCoords: this.handleSlatCoords }),
        p(nc, {
          cells: e.cells,
          axis: e.axis,
          dateProfile: e.dateProfile,
  ...
  function fc(e) {
    return p(y, null, e.text && p('a', Object.assign({ id: e.textId, className: 'fc-list-day-text' }, e.navLinkAttrs), e.text), e.sideText && p('a', Object.assign({ 'aria-hidden': !0, className: 'fc-list-day-side-text' }, e.sideNavLinkAttrs), e.sideText))
  }
      ...
      list: {
        component: class extends ls {
          ...
          renderEmptyMessage() {
            ...
            return p(Jn, { elTag: 'div', elClasses: ['fc-list-empty'], renderProps: n, generatorName: 'noEventsContent', customGenerator: e.noEventsContent, defaultGenerator: vc, classNameGenerator: e.noEventsClassNames, didMount: e.noEventsDidMount, willUnmount: e.noEventsWillUnmount }, (e) =>
    ...
    render() {
      ...
      return p(
        ...
        p(
          ...
          p('table', { className: ['fc-multimonth-header-table', n.theme.getClass('table')].join(' '), role: 'presentation' }, p('thead', { role: 'rowgroup' }, p(_s, { dateProfile: e.dateProfile, dates: o.headerDates, datesRepDistinctDays: !1 })))
        ),
        p(
          'div',
          ...
          p(
            ...
            p('tbody', { role: 'rowgroup' }, p(Sl, Object.assign({}, a, { dateProfile: r, cells: o.cells, eventSelection: e.eventSelection, dayMaxEvents: !i, dayMaxEventRows: !i, showWeekNumbers: s.weekNumbers, clientWidth: e.clientWidth, clientHeight: e.clientHeight, forPrint: i })))
          )
        )
      )
    }
        ...
        super(),
          ...
          (this.handleRenderRequest = () => {
            if (this.isRendering) {
              ...
              jn(() => {
                U(
                  p(ki, { options: e.calendarOptions, theme: e.theme, emitter: e.emitter }, (t, n, r, i) => (this.setClassNames(t), this.setHeight(n), p($n.Provider, { value: this.customContentRenderId }, p(_a, Object.assign({ isHeightAuto: r, forPrint: i }, e))))),
                  this.el
                )
              })
