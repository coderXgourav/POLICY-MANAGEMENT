!(function (e, r) {
  ...
  function f(t, s, u) {
    ...
    function m(e) {
      ...
      var r = (function (e, r) {
        ...
        n = null
      return (
        (t = f.config.classTo === f.config.errorTextParent ? r : r.querySelector('.' + f.config.errorTextParent)) &&
          ((n = t.querySelector('.pristine-error')) || (((n = document.createElement(f.config.errorTextTag)).className = 'pristine-error ' + f.config.errorTextClass), t.appendChild(n), (n.pristineDisplay = n.style.display))),
        (e.errorElements = [r, n])
      )
    }
    function d(e) {
      var r = m(e),
        ...
        n = r[1],
        i = e.input,
        s = 'error-' + (i.id || Math.floor(new Date().valueOf() * Math.random()))
      t && (t.classList.remove(f.config.successClass), t.classList.add(f.config.errorClass), i.setAttribute('aria-describedby', s), i.setAttribute('aria-invalid', 'true')),
        n && (n.setAttribute('id', s), n.setAttribute('role', 'alert'), (n.innerHTML = e.errors.join('<br/>')), (n.style.display = n.pristineDisplay || ''))
    }
    function h(e) {
      var r = (function (e) {
        var r = m(e),
          ...
          n = r[1],
          i = e.input
        return t && (t.classList.remove(f.config.errorClass), t.classList.remove(f.config.successClass), i.removeAttribute('aria-describedby'), i.removeAttribute('aria-invalid')), n && (n.removeAttribute('id'), n.removeAttribute('role'), (n.innerHTML = ''), (n.style.display = 'none')), r
      })(e)[0]
    ...
    return (
      (function (e, r, t) {
        e.setAttribute('novalidate', 'true'),
          ...
          (f.live = !(!1 === t)),
          (f.fields = Array.from(e.querySelectorAll('input:not([type^=hidden]):not([type^=submit]), select, textarea')).map(
            function (e) {
              var r = [],
                t = {},
                n = {}
  ...
  return (
    ...
    u('required', {
      fn: function (e) {
        return 'radio' === this.type || 'checkbox' === this.type ? t(this) : void 0 !== e && '' !== e.trim()
      },
      priority: 99,
      halt: !0
    }),
