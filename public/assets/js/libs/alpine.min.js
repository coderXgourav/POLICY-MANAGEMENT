    ...
    return (
      Object.entries(ur).forEach(([r, n]) => {
        ...
        function o() {
          ...
          {
            let [s, a] = ht(t);
            return (i = { interceptor: De, ...s }), ee(t, a), i;
          }
        }
...
`
  ...
  function Pn(e, t, r) {
    ...
    return (i = () => {}, { scope: o = {}, params: s = [] } = {}) => {
      ...
      if (typeof n == "function") {
        ...
        n.finished
          ? (Ie(i, n.result, a, s, r), (n.result = void 0))
          : c
              .then((l) => {
                Ie(i, l, a, s, r);
              })
  ...
  function Ie(e, t, r, n, i) {
    if (Pe && typeof t == "function") {
      ...
      o instanceof Promise
        ? o.then((s) => Ie(e, s, r, n)).catch((s) => te(s, i, t))
        : e(o);
    } else
  ...
  var ii = Object.prototype.toString,
    ...
    Rt = (e) => Ur(e).slice(8, -1);
  var qe = (e) =>
    ni(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
  var Ue = (e) => {
  ...
  function nn(e = !1, t = !1) {
    return function (n, i, o) {
      ...
      return (Ve(i) ? rn.has(i) : di(i)) || (e || N(n, "get", i), t)
        ? a
        : It(a)
        ? !s || !qe(i)
          ? a.value
  ...
  var wi = { get: pi, set: hi, deleteProperty: xi, has: yi, ownKeys: bi },
    Ei = {
      get: mi,
      set(e, t) {
        return (
  ...
  y(
    "refs",
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = B(Ii(e))), e._x_refs_proxy)
  );
  function Ii(e) {
    let t = [];
    return (
  ...
  d("cloak", (e) =>
    queueMicrotask(() => _(() => e.removeAttribute(T("cloak"))))
  );
  Oe(() => `[${T("init")}]`);
  d(
    "init",
  ...
  z.setEvaluator(xt);
  z.setReactivityEngine({ reactive: Qe, effect: Zr, release: Qr, raw: h });
  var Kt = z;
  window.Alpine = Kt;
  queueMicrotask(() => {
    Kt.start();
