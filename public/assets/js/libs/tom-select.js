...
!(function (e, t) {
  ...
  const A = (e) => {
    ...
    F = (e, t, i) => {
      var s, n
      return e ? ((e += ''), null == t.regex || -1 === (n = e.search(t.regex)) ? 0 : ((s = t.string.length / e.length), 0 === n && (s += 0.5), s * i)) : 0
    },
    L = (e, t) => {
      var i = e[t]
  ...
  class de extends (function (e) {
    ...
    setActiveOption(e, t = !0) {
      e !== this.activeOption && (this.clearActiveOption(), e && ((this.activeOption = e), Q(this.focus_node, { 'aria-activedescendant': e.getAttribute('id') }), Q(e, { 'aria-selected': 'true' }), D(e, 'active'), t && this.scrollToOption(e)))
    }
    scrollToOption(e, t) {
      if (!e) return
    ...
    inputState() {
      ...
      e.control.contains(e.control_input) &&
        ...
        e.activeItems.length > 0 || (!e.isFocused && e.settings.hidePlaceholder && e.items.length > 0) ? (e.setTextboxValue(), (e.isInputHidden = !0)) : (e.settings.hidePlaceholder && e.items.length > 0 && Q(e.control_input, { placeholder: '' }), (e.isInputHidden = !1)),
    ...
    search(e) {
      ...
      return (
        e !== s.lastQuery ? ((s.lastQuery = e), (t = s.sifter.search(e, Object.assign(n, { score: i }))), (s.currentResults = t)) : (t = Object.assign({}, s.currentResults)),
    ...
    open() {
      ...
      e.isLocked ||
        ...
        ((e.isOpen = !0), Q(e.focus_node, { 'aria-expanded': 'true' }), e.refreshState(), q(e.dropdown, { visibility: 'hidden', display: 'block' }), e.positionDropdown(), q(e.dropdown, { visibility: 'visible', display: 'block' }), e.focus(), e.trigger('dropdown_open', e.dropdown))
    }
    close(e = !0) {
      var t = this,
        i = t.isOpen
      ...
      n.rtl && (e *= -1),
        n.inputValue().length ||
          (ne(J, t) || ne('shiftKey', t)
            ? (s = (i = n.getLastActive(e)) ? (i.classList.contains('active') ? n.getAdjacent(i, e, 'item') : i) : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (s.classList.contains('active') && n.removeActiveItem(i), n.setActiveItemClass(s))
            : n.moveCaret(e))
    }
    moveCaret(e) {}
    getLastActive(e) {
      ...
      if (
        ...
        'option' === e || 'option_create' === e
          ? t[n.settings.disabledField]
            ...
            : Q(s, { 'data-selectable': '' })
          : 'optgroup' === e && ((i = t.group[n.settings.optgroupValueField]), Q(s, { 'data-group': i }), t.group[n.settings.disabledField] && Q(s, { 'data-disabled': '' })),
        'option' === e || 'item' === e)
      ) {
  ...
  return (
    ...
    de.define('checkbox_options', function (e) {
      ...
      var n = function (e, t) {
          t
            ? ((e.checked = !0), s.uncheckedClassNames && e.classList.remove(...s.uncheckedClassNames), s.checkedClassNames && e.classList.add(...s.checkedClassNames))
            : ((e.checked = !1), s.checkedClassNames && e.classList.remove(...s.checkedClassNames), s.uncheckedClassNames && e.classList.add(...s.uncheckedClassNames))
        },
        o = function (e) {
          setTimeout(() => {
    ...
    de.define('clear_button', function (e) {
      const t = this,
        i = Object.assign({ className: 'clear-button', title: 'Clear All', html: (e) => `<div class="${e.className}" title="${e.title}">&#10799;</div>` }, e)
      t.on('initialize', () => {
        var e = j(i.html(i))
      ...
      ;(e.setNextUrl = (e, t) => {
        ...
        e.on('initialize', () => {
          ;(a = Object.keys(e.options)),
            (n = e.dropdown_content),
            (e.settings.render = Object.assign({}, { loading_more: () => '<div class="loading-more-results">Loading more results ... </div>', no_more_results: () => '<div class="no-more-results">No more results</div>' }, e.settings.render)),
