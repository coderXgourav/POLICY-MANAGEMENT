...
!(function (t, e) {
    ...
    for (var t = 1; t < arguments.length; t++) {
      ...
      t % 2
        ? e(Object(i), !0).forEach(function (t) {
            var e, n
            ;(e = o), (t = i[(n = t)]), n in e ? Object.defineProperty(e, n, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : (e[n] = t)
          })
  ...
  function X(t, e, n, o, i) {
    if (t.getBoundingClientRect || t === window) {
      ...
      return o && t !== window && ((o = (e = v(i || t)) && e.a), (t = e && e.d), e && ((s = (a /= t) + (u /= t)), (c = (l /= o) + (d /= o)))), { top: a, left: l, bottom: s, right: c, width: d, height: u }
    }
  }
  function Y(t, e, n) {
        ...
        ;(o = []),
          this.options.animation &&
            [].slice.call(this.el.children).forEach(function (t) {
              var e, n
              'none' !== R(t, 'display') && t !== Ft.ghost && (o.push({ target: t, rect: X(t) }), (e = I({}, o[o.length - 1].rect)), !t.thisAnimationDuration || ((n = v(t, !0)) && ((e.top -= n.f), (e.left -= n.e))), (t.fromRect = e))
            })
      },
        ...
        o.forEach(function (t) {
          ...
          s && ((i.top -= s.f), (i.left -= s.e)),
            ...
            n.thisAnimationDuration &&
              ...
              ((t = l), (s = r), (r = a), (a = c.options), (e = (Math.sqrt(Math.pow(s.top - t.top, 2) + Math.pow(s.left - t.left, 2)) / Math.sqrt(Math.pow(s.top - r.top, 2) + Math.pow(s.left - r.left, 2))) * a.animation)),
            D(i, o) || ((n.prevFromRect = o), (n.prevToRect = i), (e = e || c.options.animation), c.animate(n, l, i, e)),
            e &&
              ((u = !0),
              (d = Math.max(d, e)),
  ...
  function z(t) {
    ...
    if ((e = e || (n && n[K]))) {
      ...
      !window.CustomEvent || y || w ? (g = document.createEvent('Event')).initEvent(o, !0, !0) : (g = new CustomEvent(o, { bubbles: !0, cancelable: !0 })),
        (g.to = a || n),
        (g.from = l || n),
        (g.item = i || n),
        (g.clone = r),
  ...
  var U = ['evt']
  function q(t) {
    z(I({ putSortable: st, cloneEl: et, targetEl: V, rootEl: Q, oldIndex: ot, oldDraggableIndex: rt, newIndex: it, newDraggableIndex: at }, t))
  }
  var V,
    Z,
    $,
  ...
  function jt(t, e, n, o, i, r, a, l) {
    var s,
      ...
      d = u.options.onMove
    return (
      !window.CustomEvent || y || w ? (s = document.createEvent('Event')).initEvent('move', !0, !0) : (s = new CustomEvent('move', { bubbles: !0, cancelable: !0 })),
      (s.to = e),
      (s.from = t),
      (s.dragged = n),
      (s.draggedRect = o),
  ...
  ;(Ft.prototype = {
    ...
    _onTapStart: function (e) {
      if (e.cancelable) {
        ...
        if (
          ...
          !V && !((/mousedown|pointerdown/.test(r) && 0 !== e.button) || t.disabled) && !s.isContentEditable && (this.nativeDraggable || !u || !l || 'SELECT' !== l.tagName.toUpperCase()) && !(((l = P(l, t.draggable, o, !1)) && l.animated) || tt === l))
        ) {
          if (((ot = j(l)), (rt = j(l, t.draggable)), 'function' == typeof c)) {
            if (c.call(this, e, l, this)) return q({ sortable: n, rootEl: s, name: 'filter', targetEl: l, toEl: o, fromEl: o }), G('filter', n, { evt: e }), void (i && e.cancelable && e.preventDefault())
          } else if (
            (c =
              c &&
              c.split(',').some(function (t) {
                if ((t = P(s, t.trim(), o, !1))) return q({ sortable: n, rootEl: t, name: 'filter', targetEl: l, fromEl: o, toEl: o }), G('filter', n, { evt: e }), !0
              }))
          )
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      n &&
        ...
        (tt = n),
        (lt = a.group),
        (ct = { target: (Ft.dragged = V), clientX: (e || t).clientX, clientY: (e || t).clientY }),
        ...
        (o = function () {
          G('delayEnded', i, { evt: t }), Ft.eventCanceled ? i._onDrop() : (i._disableDelayedDragEvents(), !s && i.nativeDraggable && (V.draggable = !0), i._triggerDragStart(t, e), q({ sortable: i, name: 'choose', originalEvent: t }), k(V, a.chosenClass, !0))
        }),
        ...
        s && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (V.draggable = !0)),
    ...
    _dragStarted: function (t, e) {
      var n
      ;(wt = !1),
        Q && V ? (G('dragStarted', this, { evt: e }), this.nativeDraggable && h(document, 'dragover', Bt), (n = this.options), t || k(V, n.dragClass, !1), k(V, n.ghostClass, !0), (Ft.active = this), t && this._appendGhost(), q({ sortable: this, name: 'start', originalEvent: e })) : this._nulling()
    },
    _emulateDragOver: function () {
      if (ut) {
        ...
        if ((V.parentNode[K]._isOutsideThisEl(t), e))
          do {
            if (e[K]) if (e[K]._onDragOver({ clientX: ut.clientX, clientY: ut.clientY, target: t, rootEl: e }) && !this.options.dragoverBubble) break
    ...
    _onTouchMove: function (t) {
      if (ct) {
        ...
        $ &&
          (r ? ((r.e += a - (dt || 0)), (r.f += l - (ht || 0))) : (r = { a: 1, b: 0, c: 0, d: 1, e: a, f: l }),
    ...
    _appendGhost: function () {
      if (!$) {
        ...
        k(($ = V.cloneNode(!0)), n.ghostClass, !1),
          ...
          (Ft.ghost = $),
          t.appendChild($),
          R($, 'transform-origin', (ft / parseInt($.style.width)) * 100 + '% ' + (pt / parseInt($.style.height)) * 100 + '%')
      }
    },
    _onDragStart: function (t, e) {
      ...
      G('dragStart', this, { evt: t }),
        Ft.eventCanceled
          ? this._onDrop()
          : (G('setupClone', this),
            Ft.eventCanceled || ((et = _(V)).removeAttribute('id'), (et.draggable = !1), (et.style['will-change'] = ''), this._hideClone(), k(et, this.options.chosenClass, !1), (Ft.clone = et)),
            (n.cloneId = Kt(function () {
              G('clone', n), Ft.eventCanceled || (n.options.removeCloneOnHide || Q.insertBefore(et, V), n._hideClone(), q({ sortable: n, name: 'clone' }))
            })),
            e || k(V, i.dragClass, !0),
            e
              ? ((Et = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
              : (f(document, 'mouseup', n._onDrop), f(document, 'touchend', n._onDrop), f(document, 'touchcancel', n._onDrop), o && ((o.effectAllowed = 'move'), i.setData && i.setData.call(n, o, V)), h(document, 'drop', n), R(V, 'transform', 'translateZ(0)')),
            (wt = !0),
        ...
        if (((Et = !1), u && !s.disabled && (d ? h || (i = Z !== Q) : st === this || ((this.lastPutMode = lt.checkPull(this, u, V, n)) && c.checkPut(this, u, V, n))))) {
          ...
          if (m && ((S = n), (c = r), (x = X(F((D = this).el, D.options.draggable))), (D = L(D.el, D.options, $)), !(c ? S.clientX > D.right + 10 || (S.clientY > x.bottom && S.clientX > x.left) : S.clientY > D.bottom + 10 || (S.clientX > x.right && S.clientY > x.top)) || m.animated)) {
            if (m && ((t = n), (e = r), (C = X(B((_ = this).el, 0, _.options, !0))), (_ = L(_.el, _.options, $)), e ? t.clientX < _.left - 10 || (t.clientY < C.top && t.clientX < C.right) : t.clientY < _.top - 10 || (t.clientY < C.bottom && t.clientX < C.left))) {
              ...
              if (
                (mt !== l && ((y = E[_]), (St = !1), (_t = (!S && s.invertSwap) || D)),
                0 !==
                  (b = (function (t, e, n, o, i, r, a, l) {
                    ...
                    if (!a)
                      if (l && bt < c * i) {
                        if ((St = !St && (1 === vt ? t + (c * r) / 2 < s : s < o - (c * r) / 2) ? !0 : St)) n = !0
                    ...
                    return 0
                  })(n, l, E, r, S ? 1 : s.swapThreshold, null == s.invertedSwapThreshold ? s.swapThreshold : s.invertedSwapThreshold, _t, mt === l)))
              )
                for (var T = j(V); (w = Z.children[(T -= b)]) && ('none' === R(w, 'display') || w === $); );
      ...
      function A(t) {
        return (
          ...
          t &&
            ...
            p !== f && (k(V, (st || u).options.ghostClass, !1), k(V, s.ghostClass, !0)),
            st !== p && p !== Ft.active ? (st = p) : p === Ft.active && st && (st = null),
          ...
          s.dragoverBubble || n.rootEl || l === document || (V.parentNode[K]._isOutsideThisEl(n.target), t || Yt(n)),
          !s.dragoverBubble && n.stopPropagation && n.stopPropagation(),
          (g = !0)
        )
      }
      function N() {
        ;(it = j(V)), (at = j(V, s.draggable)), q({ sortable: p, name: 'change', toEl: a, newIndex: it, newDraggableIndex: at, originalEvent: n })
      }
    },
    ...
    _onDrop: function (t) {
      ...
      ;(it = j(V)),
        ...
        Ft.eventCanceled ||
          ...
          this.nativeDraggable && (f(document, 'drop', this), f(e, 'dragstart', this._onDragStart)),
          this._offMoveEvents(),
          this._offUpEvents(),
          u && R(document.body, 'user-select', ''),
          R(V, 'transform', ''),
          t &&
            (gt && (t.cancelable && t.preventDefault(), n.dropBubble || t.stopPropagation()),
            $ && $.parentNode && $.parentNode.removeChild($),
            (Q === Z || (st && 'clone' !== st.lastPutMode)) && et && et.parentNode && et.parentNode.removeChild(et),
            V &&
              ...
              q({ sortable: this, name: 'unchoose', toEl: Z, newIndex: null, newDraggableIndex: null, originalEvent: t }),
              Q !== Z
                ? (0 <= it && (q({ rootEl: Z, name: 'add', toEl: Z, fromEl: Q, originalEvent: t }), q({ sortable: this, name: 'remove', toEl: Z, originalEvent: t }), q({ rootEl: Z, name: 'sort', toEl: Z, fromEl: Q, originalEvent: t }), q({ sortable: this, name: 'sort', toEl: Z, originalEvent: t })),
                  st && st.save())
                : it !== ot && 0 <= it && (q({ sortable: this, name: 'update', toEl: Z, originalEvent: t }), q({ sortable: this, name: 'sort', toEl: Z, originalEvent: t })),
              Ft.active && ((null != it && -1 !== it) || ((it = ot), (at = rt)), q({ sortable: this, name: 'end', toEl: Z, originalEvent: t }), this.save())))),
        this._nulling()
    },
    _nulling: function () {
      G('nulling', this),
        (Q = V = Z = $ = J = et = tt = nt = ct = ut = gt = it = at = ot = rt = mt = vt = st = lt = Ft.dragged = Ft.ghost = Ft.clone = Ft.active = null),
    ...
    _showClone: function (t) {
      'clone' === t.lastPutMode
        ? nt && (G('showClone', this), Ft.eventCanceled || (V.parentNode != Q || this.options.group.revertClone ? (J ? Q.insertBefore(et, J) : Q.appendChild(et)) : Q.insertBefore(et, V), this.options.group.revertClone && this.animate(V, et), R(et, 'display', ''), (nt = !1)))
        : this._hideClone()
    }
  }),
    Ot &&
      ...
      if (t.scroll) {
        ...
        do {
          var f = h,
            ...
            D =
              f === c
                ? ((E = y < S && ('auto' === C.overflowX || 'scroll' === C.overflowX || 'visible' === C.overflowX)), w < _ && ('auto' === C.overflowY || 'scroll' === C.overflowY || 'visible' === C.overflowY))
                : ((E = y < S && ('auto' === C.overflowX || 'scroll' === C.overflowX)), w < _ && ('auto' === C.overflowY || 'scroll' === C.overflowY)),
  ...
  return (
    Ft.mount(
      new (function () {
        function t() {
          for (var t in ((this.defaults = { scroll: !0, forceAutoScrollFallback: !1, scrollSensitivity: 30, scrollSpeed: 10, bubbleScroll: !0 }), this)) '_' === t.charAt(0) && 'function' == typeof this[t] && (this[t] = this[t].bind(this))
        }
        return (
          (t.prototype = {
            ...
            drop: function () {
              this.sortable.nativeDraggable ? f(document, 'dragover', this._handleAutoScroll) : (f(document, 'pointermove', this._handleFallbackAutoScroll), f(document, 'touchmove', this._handleFallbackAutoScroll), f(document, 'mousemove', this._handleFallbackAutoScroll)),
                te(),
                Jt(),
                clearTimeout(g),
                (g = void 0)
            ...
            drop: function (t) {
              ...
              ee && k(ee, l.swapClass, !1),
                ee &&
                  ...
                  (t = (e = r).parentNode),
                  (l = n.parentNode),
                  t && l && !t.isEqualNode(n) && !l.isEqualNode(e) && ((i = j(e)), (r = j(n)), t.isEqualNode(l) && i < r && r++, t.insertBefore(n, t.children[i]), l.insertBefore(e, l.children[r])),
                  a.animateAll(),
                  a !== o && o.animateAll())
            },
            nulling: function () {
    ...
    Ft.mount(
      new (function () {
        function t(o) {
          ...
          o.options.avoidImplicitDeselect || (o.options.supportPointer ? h(document, 'pointerup', this._deselectMultiDrag) : (h(document, 'mouseup', this._deselectMultiDrag), h(document, 'touchend', this._deselectMultiDrag))),
        ...
        return (
          (t.prototype = {
            ...
            revert: function (t) {
              ...
              1 < ue.length &&
                (ue.forEach(function (t) {
                  r.addAnimationState({ target: t, rect: fe ? X(t) : a }), T(t), (t.fromRect = a), e.removeAnimationState(t)
                }),
                (fe = !1),
            ...
            drop: function (t) {
              ...
              if (e) {
                var c,
                  ...
                  f = o.children
                if (!pe)
                  if ((h.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), k(le, h.selectedClass, !~ue.indexOf(le)), ~ue.indexOf(le))) ue.splice(ue.indexOf(le), 1), (re = null), z({ sortable: i, rootEl: n, name: 'deselect', targetEl: le, originalEvent: e })
                  else {
                    if ((ue.push(le), z({ sortable: i, rootEl: n, name: 'select', targetEl: le, originalEvent: e }), e.shiftKey && re && i.el.contains(re))) {
                      var p = j(re),
                        t = j(le)
                      if (~p && ~t && p !== t) for (var g, m = p < t ? ((g = p), t) : ((g = t), p + 1); g < m; g++) ~ue.indexOf(f[g]) || (k(f[g], h.selectedClass, !0), ue.push(f[g]), z({ sortable: i, rootEl: n, name: 'select', targetEl: f[g], originalEvent: e }))
                    } else re = le
                    ae = s
                  }
                pe &&
                  ...
                  (o[K].options.sort || o !== n) &&
                    ...
                    he ||
                      (h.animation &&
                        ...
                        ue.forEach(function (t) {
                          var e
                          ;(t.thisAnimationDuration = null), t !== le && ((e = fe ? X(t) : c), (t.fromRect = e), s.addAnimationState({ target: t, rect: e }))
                        })),
                      me(),
                      ue.forEach(function (t) {
            ...
            _deselectMultiDrag: function (t) {
              if (!((void 0 !== pe && pe) || ae !== this.sortable || (t && P(t.target, this.options.draggable, this.sortable.el, !1)) || (t && 0 !== t.button)))
                for (; ue.length; ) {
                  var e = ue[0]
                  k(e, this.options.selectedClass, !1), ue.shift(), z({ sortable: this.sortable, rootEl: this.sortable.el, name: 'deselect', targetEl: e, originalEvent: t })
                }
            },
          ...
          a(t, {
            ...
            eventProperties: function () {
              ...
              return (
                ue.forEach(function (t) {
                  var e
                  o.push({ multiDragElement: t, index: t.sortableIndex }), (e = fe && t !== le ? -1 : fe ? j(t, ':not(.' + n.options.selectedClass + ')') : j(t)), i.push({ multiDragElement: t, index: e })
                }),
