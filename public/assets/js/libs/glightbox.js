!(function (e, t) {
          ...
          value: function (e) {
            if (this.slide.classList.contains('zoomed')) this.active = !1
              ...
              e.target.classList.contains('nodrag') || g(e.target, '.nodrag') || -1 !== ['input', 'select', 'textarea', 'button', 'a'].indexOf(t)
                ? (this.active = !1)
                : (e.preventDefault(), (e.target === this.el || ('img' !== t && g(e.target, '.gslide-inline'))) && ((this.active = !0), this.el.classList.add('dragging'), (this.dragContainer = g(e.target, '.ginner-container'))))
            }
          }
        },
        {
    ...
    ;(r.style.maxWidth = t.width),
      w(this.settings.plyr.js, 'Plyr', function () {
        if (
          ...
          !u &&
            (c.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || c.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) || c.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/) || c.match(/(youtube\.com|youtube-nocookie\.com)\/shorts\/([a-zA-Z0-9\-_]+)/)) &&
            (u = 'youtube'),
          'local' === u || !u)
        ) {
          u = 'local'
  ...
  var j = s(
      function e() {
        ...
        i(this, e), (this.defaults = { href: '', sizes: '', srcset: '', title: '', type: '', videoProvider: '', description: '', alt: '', descPosition: 'bottom', effect: '', width: '', height: '', content: !1, zoomable: !0, draggable: !0 }), I(t) && (this.defaults = o(this.defaults, t))
      },
      [
        {
          key: 'sourceType',
            ...
            if (
              ...
              '' == s.title && '' == s.description
                ...
                : (h && '' !== s.title ? ((h.id = f), (h.innerHTML = s.title)) : h.parentNode.removeChild(h),
                  c && '' !== s.description ? ((c.id = p), l && n.moreLength > 0 ? ((s.smallDescription = this.slideShortDesc(s.description, n.moreLength, n.moreText)), (c.innerHTML = s.smallDescription), this.descriptionEvents(c, s)) : (c.innerHTML = s.description)) : c.parentNode.removeChild(c),
