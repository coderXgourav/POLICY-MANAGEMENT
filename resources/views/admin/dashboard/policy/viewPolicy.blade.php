@include('admin.dashboard.header')
    ...
    <main
                  ...
                  <tbody>
                    {{-- <template x-for="file in items"> --}}
                      ...
                      <td class="px-6" :class="dense? 'py-1.5': 'py-3'">
                       ...
                       <button class="btn btn-warning" onclick="Delete('/admin/delete-policy',{{$value->policy_id}})">Delete</button>
                      </td>
      ...
      @else 
      <tr>
        <td colspan="4" style="color: red; text-align:center; "> Empty Policy .</td>
      </tr>
                      @endif 
